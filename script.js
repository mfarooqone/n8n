...
if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
        ...
        emailjs.send("service_l72gznh", "template_c21upwh", {
            from_name: name,
            from_email: email,
            to_name: "Muhammad Farooq Iqbal",
            to_email: "mfarooqiqbal143@gmail.com",
            message: message,
            reply_to: email
        })
        .then(function(response) {
            ...
            showNotification('Sorry, there was an error sending your message. Please try again or email me directly at mfarooqiqbal143@gmail.com', 'error');
        })
        .finally(function() {
            // Reset button state
